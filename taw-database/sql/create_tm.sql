...
(
   ...
   center_lng           decimal(17,10) comment '经度',
   center_lat           decimal(17,10) comment '纬度',
   left_top_lng         decimal(17,10) comment '经度',
   left_top_lat         decimal(17,10) comment '纬度',
   left_bottom_lng      decimal(17,10) comment '经度',
   left_bottom_lat      decimal(17,10) comment '纬度',
   right_top_lng        decimal(17,10) comment '经度',
   right_top_lat        decimal(17,10) comment '纬度',
   right_bottom_lng     decimal(17,10) comment '经度',
   right_bottom_lat     decimal(17,10) comment '纬度',
